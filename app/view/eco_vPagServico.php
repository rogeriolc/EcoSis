	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="header">
					<h2>
						<i class="material-icons pull-left col-deep-purple" style="padding-right: 8px; margin-top: -2px;">assignment</i> Meus Serviços
					</h2>
					<ul class="header-dropdown m-r--5">
						<li class="dropdown">
							...
							<ul class="dropdown-menu pull-right">
								<li><a data-toggle="modal" href="javascript:void(0)" onclick="viewFormServico(null)" class="waves-effect waves-block"><i class="material-icons">add</i> Novo Serviço</a></li>
							</ul>
						</li>
					</ul>
				</div>
...
<script type="text/javascript">
	...
	function viewFormServico(s, showLoading=true, anim=true){

		var divForm = $("#viewFormServico");
		...
		$.ajax({
			url: 'action/eco_viewFormServico.php',
			type: 'POST',
			data: {
				cdServico: s,
				divAnimate: anim
