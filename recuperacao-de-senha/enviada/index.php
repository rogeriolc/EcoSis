...
<body class="mdc-bg-grey-200">
	...
	<div class="login-page" style="background: none; max-width: 560px;">
		<div class="login-box">
			...
			<div class="card">
				<div class="body">
					...
					if(is_null($token)){ 
						...
						<span class="text-center col-red">Token inválido</span>
						...
						if (!isset($cdUsuario) || $cdUsuario == 0 || is_null($cdUsuario)) {
							...
							echo '<span class="col-red text-center">Token inválido!</span>';

						} else {
							?>
							<div class="text-center">
								<i class="material-icons col-green" style="font-size: 100px;">check_circle</i>
							</div>

							<h2 class="text-center">Recuperação Enviada!</h2>
							<br>
							<br>
							<p class="text-center font-18">Confira seu email! Uma mensagem de recuperação de senha foi enviada para o ele.</p>
							<?php
						}
					}
					?>
